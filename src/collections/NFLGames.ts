...
export const NFLGames: CollectionConfig = {
  slug: 'nfl-games',
  labels: {
    singular: 'Game (NFL / NCAA Football)',
    plural: 'Games (NFL / NCAA Football)',
  },
  admin: {
    useAsTitle: 'slug',
    defaultColumns: ['homeTeam', 'awayTeam', 'competition', 'kickoffTime', 'status'],
    description: 'Shared by both the NFL and NCAA Football competitions — the same sport, different tiers.',
  },
  access: {
    read: () => true,
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      admin: {
        description: 'e.g. "Week 5", "Wild Card", "Super Bowl LX"',
      },
    },
    {
      name: 'season',
